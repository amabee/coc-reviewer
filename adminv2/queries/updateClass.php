...
// Add a function to validate other fields if necessary

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $assignedTeacherId = sanitizeInput($_POST["updateAssignedTeacherId"]);
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            $insertAuditQuery = "INSERT INTO tbl_audit (action, table_name, section_id, admin_id, log_message, timestamp) VALUES (:action, :table_name, :section_id, :admin_id, :log_message, :timestamp)";
            ...
            $insertAuditStmt->bindParam(':section_id', $sectionId, PDO::PARAM_STR);
